          ...
          >
            ...
            {isConflict ? (
              <div className="border-foreground border border-dashed p-4 text-center">
                <p className="text-foreground text-sm font-bold tracking-[0.15em] uppercase">
                  {t('claim.conflict')}
                </p>
                <p className="text-muted-foreground mt-2 text-xs">
                  {t('claim.conflict_hint')}
                </p>
              </div>
            ) : (
              <>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="bg-background border-foreground text-foreground placeholder:text-muted-foreground focus:ring-foreground w-full border px-4 py-3 text-base focus:ring-1 focus:outline-none"
                    maxLength={30}
                    autoFocus
                    onKeyDown={(e) => {
                ...
                {claimMutation.isError && !isConflict && (
                  <p className="text-foreground mt-3 text-center text-xs tracking-[0.15em] uppercase">
                    {t('claim.error')}
                  </p>
                )}
              </>
